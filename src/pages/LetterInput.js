    ...
    return (
        <div className="single-letter-input-div">
            ...
            <div>
                ...
                <input className="hidden-radio" name={props.name} id={props.tLetterId} type="radio"></input>
                <label className="radio-label radio-label-t" htmlFor={props.tLetterId}>3x</label>
                <input className="hidden-radio" name={props.name} id={props.default} type="radio" defaultChecked></input>
                <label className="radio-label radio-label-default" htmlFor={props.default}>1x</label>
            </div>
        </div>
    )
}